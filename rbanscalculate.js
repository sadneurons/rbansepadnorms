...
function calculate(document) {
    ...
    figure_recall_text = "Recalling the complex figure is difficult, and you scored  " + figure_recall + "/20. "
    story_recall_text = "You remembered " + story_recall + " items out of a possible 12 from the short story. "
    list_text = "You scored " + listlearning + "/40 on the word list learning task which is a sensitive indicator of your ability to remember new words."
    ...
    var memcentile = (100 * GetZPercent(delayed_memory_z)).toFixed(1)
    var mem_centile_text = " This means that " + memcentile + "% of healthy people in your age group score worse than you on this subtest."
    ...
    //VISUoSPATIAL
    var orientation_text = "You scored " + line_orientation + "/20 on the line orientation task which tests visual perceptual ability."
    ...
    document.getElementById('visuospatial_letter').innerHTML = "<h2>Visuospatial Function</h2>" + orientation_text + figure_copy_text + visuospatial_text + visuospatial_centile_text
